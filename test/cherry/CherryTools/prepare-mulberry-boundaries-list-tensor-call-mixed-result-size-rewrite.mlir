...
// CHECK-SAME: (index, index) -> (i64, !mulberry.list_desc<!mulberry.tensor_desc<?x?xf32>>)
// CHECK: %[[LENGTH:.*]] = mulberry.list.desc_length %{{.*}}#1
...
// CHECK: return %{{.*}}, %{{.*}} : i64, !mulberry.list_desc<!mulberry.tensor_desc<?x?xf32>>
